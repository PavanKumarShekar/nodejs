...
var db_host = (process.env.mongodb_host || "ds211440.mlab.com" ) ;
var db_port = (process.env.mongodb_port || "11440" ) ;
var db_user = (process.env.mongodb_user || "pavan" ) ;
var db_pwd  = (process.env.mongodb_pwd  || "cmpe281" ) ;
var db_name = (process.env.mongodb_name || "heroku_gffltfd0" ) ;
